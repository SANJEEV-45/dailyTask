...
<script src="dashboard.js"></script>
    <div class="sidebar">
        ...
        <div class="menu">
            <a href="./dashboardView.php#overview"><ion-icon name="desktop"></ion-icon> Home</a>
            <a href="UsersList"><ion-icon name="people"></ion-icon> Users</a>
            <a href="./dashboardView.php#music"><ion-icon name="list-box"></ion-icon> Products</a>
            <a href="editProfile.php"><ion-icon name="create"></ion-icon></i> Edit Profile</a>
