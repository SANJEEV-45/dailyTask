...
<head>
    ...
    <link href="./siteDesigning/dashboard.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <section id="music">
        <div class="music-content">
             ...
             <figure class="mobile">
                <img src="./imgSource/mobile.png" alt="mobile image">
             </figure>
        </div>
    </section>
    ...
    <section id="movie">
        <div class="movie-content">
            ...
            <figure class="movie-screen">
                <img src="./imgSource/myTunes.png" alt="mytunes site">
            </figure>
        </div>
    </section>
    ...
    <section id="Gift-card">
       <div class="gift-content">
          <figure class="card">
             <img src="./imgSource/cards.png" alt="cards">
          </figure>
